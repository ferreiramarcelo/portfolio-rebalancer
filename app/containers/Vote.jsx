...
class Vote extends Component {
    ...
    render() {
        const {
            ...
            investmentAmountTextFieldError,
            generateSteps,
            saveModelPortfolio,
        ...
        if (!view.displayTable && !view.displaySteps) {
            ...
            return (
                <div>
                    ...
                    <Portfolio componentAvailability={componentAvailability} selectedModelPortfolio={selectedModelPortfolio} selectedModelPortfolioTextFieldChange={selectedModelPortfolioTextFieldChange} portfolio={portfolio} addSecurity={addSecurity} removeSecurity={removeSecurity} securityTextFieldChange={securityTextFieldChange} addSecurity={addSecurity} saveModelPortfolio={saveModelPortfolio} deleteModelPortfolio={deleteModelPortfolio}/>
                    <br/><br/>
                    <InvestmentAmount investmentAmount={investmentAmount} errorText={investmentAmount.errorText} investmentAmountTextFieldChange={investmentAmountTextFieldChange} investmentAmountTextFieldValid={investmentAmountTextFieldValid} investmentAmountTextFieldError={investmentAmountTextFieldError}/>
                    <br></br>
                    <br></br>
